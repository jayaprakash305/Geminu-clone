...
const Sidebar = () => {
  ...
  return (
    <div className='min-h-[100vh] inline-flex flex-col justify-between bg-bgSecondaryColor py-6 px-4 transition-10ms ]'>
        <div>
        <Menu
        size={20}
        ...
        />
        <div className=' mt-2.5 inline-flex py-2.5 items-center gap-2.5 px-4 bg-bgPrimaryColor rounded-full text-gray-400 cursor-pointer'
        onClick={()=>{
